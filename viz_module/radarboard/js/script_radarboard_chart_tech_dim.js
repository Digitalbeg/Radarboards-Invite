...
legendTechDim.markers.template.setAll({ width: 20, height: 20 });
...
/* titleHoleTechDim.events.on("click", function (ev) { console.log("Clicked! Text Mitte"); }); */

/* var tooltipTextMitte = am5.Tooltip.new(root, { pointerOrientation: "down", autoTextColor: false, getFillFromSprite: false });
tooltipTextMitte.get("background").setAll({ fillOpacity: 0.65, fill: ColorGrauValue3 });
tooltipTextMitte.label.setAll({ fill: ColorBlackYAxisText });

titleHoleTechDim.setAll({
  tooltip: tooltipTextMitte,
  tooltipY: 7,

  tooltipText: "[fontWeight: 400 fontSize: 15px]Einschätzung der Schwerpunkte der\nProjekte auf folgender Grundlage:\n[fontWeight: 500 fontSize: 15px]• Antrag \n• Zwischenbericht\n• Projektabschluss",
});
 */

var textDynamischStandAntrag = "[fontStyle: italic fontWeight: 400 fontSize: 0.8em]Stand 2021[/]";
var textDynamischStandZB2021 = "[fontStyle: italic fontWeight: 400 fontSize: 0.8em]Stand Dezember 2022[/]";
var textDynamischStandTagung2021 = "[fontStyle: italic fontWeight: 400 fontSize: 0.8em]Stand August 2023[/]";
...
for (var index = 0; index < dataDimensionen.length - 1; index++) {
  ...
  textDimTooltip = "[fontSize: 16px fontWeight: 600]" + dataDimensionen[index].nameKurz + "[/]\n[fontSize: 14px fontWeight: 400]" + dataDimensionen[index].textLang + "[/]";
