...
const ColorGrauValue1 = am5.Color.lighten(am5.color(0x909090), 0.0); // für äußeren Kreis bei Einzelradarboard als Hintergrund
const ColorGrauValue2 = am5.Color.lighten(am5.color(0xD1D1D1), 0.0); // für mittleren Kreis bei Einzelradarboard als Hintergrund
const ColorGrauValue3 = am5.Color.lighten(am5.color(0xF3F3F3), 0.0); // für inneren Kreis bei Einzelradarboard als Hintergrund Farbe
